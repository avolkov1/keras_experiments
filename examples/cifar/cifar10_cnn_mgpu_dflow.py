...
Requires installation of tensorpack to run.
...
from keras_exp.multigpu import make_parallel, ModelMGPU
from keras_exp.mixin_models.dataflow import ModelDataflowMixin
...
class ModelMGPU_Dflow(ModelDataflowMixin, ModelMGPU):
    pass
